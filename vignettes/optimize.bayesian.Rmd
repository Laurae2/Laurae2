...
As with any vector optimization, please make sure the type of the data is correct. For instance, \code{c(max_depth = 5, subsample = 0.1, tree_method = "hist")} is a character vector. By default, automatic transformation is made so you just have to pick up the element by the index, everything is done for you.
